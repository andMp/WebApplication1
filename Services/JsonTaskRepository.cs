...
//                return new List<RozkStr>();
//            }

//            try
//            {
//                var json = File.ReadAllText(FilePath);
//                var list = JsonSerializer.Deserialize<List<RozkStr>>(json) ?? new List<RozkStr>();
...
//        public void SaveTasks(List<RozkStr> tasks)
//        {
//            try
//            {
...
//        public void Update(RozkStr task)
//        {
//            var tasks = LoadTasks();
